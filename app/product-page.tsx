...
export default function ProductPage() {
  ...
  const relatedProducts = [
    {
      id: 1,
      name: "Ocean Nuit™ Deep Blue Essence – Eau de Parfum 100ml",
      price: "$87.39",
    ...
    {
      id: 2,
      name: "Midnight Stiletto™ – Deluxe Femme Fragrance 80ml",
      price: "$99.99",
      originalPrice: "$149.99",
      rating: 4.8,
      image: "/good girl carolina.jpeg",
    },
    {
      id: 3,
      name: "Wild Instinct™ Intense Elixir – Men's Parfum 100ml",
      price: "$89.95",
    ...
    {
      id: 4,
      name: "Noir Orchidée™ – Luxury Unisex Parfum 50ml",
      price: "$79.99",
      originalPrice: "$119.99",
      rating: 4.7,
      image: "/tom ford black.png",
    },
  ]
  ...
  const reviews = [
    {
      ...
      rating: 5,
      date: "2 dias atrás",
      text: "Recebi minha caixa Temu de perfumes em casa e fiquei impressionada! Paguei um terço do preço das lojas. Recomendo demais!",
      photo: "/depoimento 1.png"
    },
    {
      id: 2,
      name: "Fernanda Lima",
      ...
      rating: 5,
      date: "3 dias atrás",
      text: "A caixa Temu chegou super rápido, tudo muito bem embalado. Perfumes maravilhosos por um preço inacreditável!"
    },
    {
      id: 3,
      name: "Juliana Alves",
      ...
      rating: 5,
      date: "1 semana atrás",
      text: "Valeu cada centavo! Recebi minha caixa Temu e os perfumes são incríveis. Atendimento excelente."
    },
    {
      id: 4,
      name: "Vinícius Souza",
      ...
      rating: 5,
      date: "4 dias atrás",
      text: "Nunca pensei que receberia perfumes importados em casa por esse valor. Temu está de parabéns!",
      photo: "/depoimento 3.png"
    },
    {
      id: 5,
      ...
      rating: 5,
      date: "5 dias atrás",
      text: "A caixa Temu de perfumes é sensacional! Chegou certinho, economizei muito. Vou comprar de novo!"
    },
    {
      id: 6,
      name: "Patrícia Gomes",
      ...
      rating: 5,
      date: "1 semana atrás",
      text: "Fiquei surpresa com a qualidade dos perfumes. Chegou tudo certinho em casa, recomendo a Temu!"
    },
    {
      id: 7,
      name: "Rafael Torres",
      ...
      rating: 5,
      date: "1 semana atrás",
      text: "Perfumes originais, entrega rápida e preço muito abaixo do mercado. Temu ganhou um cliente fiel!",
      photo: "/Depoimento 4.png"
    },
    {
      id: 8,
      name: "Lucas Martins",
      ...
      text: "Recebi minha caixa Temu e fiquei muito satisfeito. Perfumes de qualidade e economia de verdade!"
    },
    {
      id: 9,
      name: "Mariana Silva",
      ...
      rating: 5,
      date: "2 semanas atrás",
      text: "Amei minha caixa Temu! Chegou tudo perfeito, perfumes maravilhosos e preço justo."
    },
    {
      id: 10,
      name: "Beatriz Rocha",
      ...
      text: "Nunca imaginei comprar perfumes importados por esse preço. Temu superou minhas expectativas!",
      photo: "/depoimento 2.png"
    },
    {
      id: 11,
      name: "Eduardo Lima",
      ...
      rating: 5,
      date: "3 semanas atrás",
      text: "Recebi minha caixa Temu em casa, tudo original e com preço imbatível. Recomendo para todos!"
    },
    {
      id: 12,
      ...
      rating: 5,
      date: "1 mês atrás",
      text: "Muito satisfeito com a Temu! Perfumes de qualidade, entrega rápida e preço excelente."
    },
  ]
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white">
        <div className="relative">
          ...
          >
            <Image
                              src={productImages[selectedImage] || "https://picsum.photos/400/400?random=20"}
              alt="Storage Cabinet"
              width={400}
              height={400}
          ...
          <div className="inline-block w-full max-w-md mx-auto">
            <div style={{ display: 'flex', justifyContent: 'center', width: '100%' }}>
              <ShopifyBuyButton
                ...
                productPrice={73.57}
                                  productImage="https://picsum.photos/400/400?random=20"
