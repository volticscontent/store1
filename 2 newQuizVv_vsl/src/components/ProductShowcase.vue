<template>
  <div class="product-showcase-container w-full">
          ...
          @click="selectProduct(index)"
           ...
           <div class="p-1 h-full flex flex-col relative">
             ...
             <div class="absolute -top-1 -right-1 z-10">
               <div class="bg-gradient-to-r from-red-500 to-red-600 text-white px-2 py-1 rounded-full text-xs font-bold shadow-lg animate-pulse">
                 -{{ product.discount }}
               </div>
             </div>
             ...
             <div class="relative mb-1 flex-shrink-0">
                             <div class="w-full h-[17rem] sm:h-[20rem] rounded-lg overflow-hidden bg-gradient-to-br from-slate-100 to-slate-200 flex items-center justify-center">
                <img 
               ...
               <!-- Badge de categoria -->
               <div class="absolute bottom-1 left-1 bg-blue-100 text-blue-700 px-2 py-0.5 rounded-full text-xs font-medium">
                 {{ product.category }}
               </div>
             </div>
    ...
    <div class="flex justify-center mt-6">
      <div class="bg-gradient-to-r from-blue-100 to-blue-50 rounded-full px-6 py-3 shadow-sm">
        <div class="flex items-center gap-3">
          <div class="w-8 h-8 relative">
            ...
            <div class="absolute inset-0 flex items-center justify-center">
              <span class="text-xs font-bold text-blue-600">{{ timeLeft }}</span>
            </div>
          </div>
