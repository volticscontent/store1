...
<template>
  <div>
    ...
    <!-- Products/Promotion screen -->
    <div v-if="currentScreen === 'products'" class="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 px-1 animate-slide-in-up">
      <div class="w-full max-w-7xl mx-auto">
        <!-- Header -->
        <div class="text-center mb-12">
          <div class="inline-flex items-center gap-2 bg-blue-100 text-blue-800 px-4 py-2 rounded-full mt-10 text-sm font-medium mb-6 animate-fade-in-up">
            <Trophy class="h-4 w-4" />
            Exclusive Thunder Collection
          </div>
          <h1 class="text-4xl sm:text-5xl lg:text-6xl font-poppins-bold text-slate-900 mb-4 leading-tight animate-fade-in-up-delay-100">
            Authentic Signed
            <span class="text-blue-600">Thunder Jerseys</span>
          </h1>
          <p class="text-xl text-slate-600 font-poppins-medium max-w-2xl mx-2 animate-fade-in-up-delay-200">
            Limited edition jerseys with verified player autographs. Available at cost price for true fans only.
          </p>
        </div>
          ...
          <div class="bg-white rounded-2xl p-6 sm:p-8 shadow-sm border border-slate-200 animate-fade-in-up-delay-400">
            <div class="grid md:grid-cols-3 gap-8 text-center">
              <div class="flex flex-col items-center hover-lift">
                <div class="w-16 h-16 bg-blue-100 rounded-2xl flex items-center justify-center mb-4 animate-scale-in">
                  <Star class="h-8 w-8 text-blue-600" />
                </div>
                <h4 class="text-lg font-poppins-semibold text-slate-900 mb-2">100% Authentic</h4>
                <p class="text-slate-600 text-sm">Verified signatures with certificate of authenticity</p>
              </div>
              <div class="flex flex-col items-center hover-lift" style="animation-delay: 0.1s;">
                ...
                <h4 class="text-lg font-poppins-semibold text-slate-900 mb-2">Limited Edition</h4>
                <p class="text-slate-600 text-sm">Exclusive collection with numbered certificates</p>
              </div>
              <div class="flex flex-col items-center hover-lift" style="animation-delay: 0.2s;">
                <div class="w-16 h-16 bg-green-100 rounded-2xl flex items-center justify-center mb-4 animate-scale-in" style="animation-delay: 0.2s;">
                  <DollarSign class="h-8 w-8 text-green-600" />
                </div>
                <h4 class="text-lg font-poppins-semibold text-slate-900 mb-2">Cost Price</h4>
                <p class="text-slate-600 text-sm">Special pricing for verified Thunder fans only</p>
              </div>
            </div>
          </div>

          <!-- Quiz CTA -->
          <div class="bg-gradient-to-r from-blue-600 to-blue-700 rounded-2xl p-8 mb-10 text-white text-center">
            <h3 class="text-2xl font-poppins-bold mb-4">
              Prove You're a True Thunder Fan
            </h3>
            <p class="text-blue-100 mb-6 max-w-2xl mx-auto">
              Watch our exclusive Thunder Management video and answer 4 simple questions to unlock your fan discount.
            </p>
            <div class="flex items-center justify-center gap-2 mb-6">
              <div class="bg-white bg-opacity-20 rounded-full px-4 py-2">
                <span class="text-sm font-medium">Each correct answer = $25 discount</span>
              </div>
            </div>
            
            <Button
              @click="goToVSL"
              class="bg-white hover:bg-blue-50 px-8 sm:px-12 md:px-16 py-6 sm:py-8 font-semibold rounded-xl shadow-lg hover:shadow-xl ripple-effect premium-press animate-premium-pulse inline-flex items-center gap-3 border-2 border-blue-600"
              style="color: #1e293b !important; font-weight: 600 !important;"
              size="lg"
            >
              <Trophy class="h-5 w-5 text-blue-600" />
              <span style="color: #1e293b !important;">Start Fan Verification</span>
            </Button>
          </div>
        </div>
      </div>
    ...
    <!-- VSL screen -->
    <div v-else-if="currentScreen === 'initial'" class="min-h-screen bg-slate-50 px-4 py-8 animate-slide-in-right">
      <div class="w-full max-w-4xl mx-auto">
        <div class="text-center mb-8">
          <div class="inline-flex items-center gap-2 bg-blue-100 text-blue-800 px-4 py-2 rounded-full text-sm font-medium mb-6 animate-fade-in-up">
          ...
          <h1 class="text-3xl sm:text-4xl lg:text-5xl font-poppins-bold text-slate-900 mb-4 leading-tight animate-fade-in-up-delay-100">
            Message from
            <span class="text-blue-600">Thunder Management</span>
          </h1>
        </div>
        ...
        <div class="space-y-8">
          ...
          <div class="bg-white rounded-2xl p-6 sm:p-8 shadow-sm border border-slate-200">
            <div class="text-center">
              ...
              <blockquote class="text-lg md:text-xl text-slate-700 leading-relaxed font-poppins-medium mb-6">
                "Answer 4 questions to prove you're a true Thunder fan and earn the opportunity to buy an autographed jersey at cost price"
              </blockquote>
              <p class="text-slate-500 font-medium">— Thunder Management Team</p>
            </div>
          </div>
          ...
          <div class="bg-gradient-to-r from-amber-50 to-orange-50 rounded-2xl p-6 border border-amber-200">
            <div class="text-center">
              <div class="flex items-center justify-center gap-2 mb-4">
                ...
                <span class="font-poppins-bold text-lg text-slate-900">Fan Verification Reward</span>
                <Star class="h-5 w-5 text-amber-500" />
              </div>
              <p class="text-slate-700 font-medium">
                Maximum discount: <span class="font-bold text-green-600">$100</span> • 
                Final price: <span class="font-bold text-blue-600">$49.99</span>
              </p>
            </div>
          </div>
          ...
          <div class="text-center pt-4">
            <Button
              ...
              class="bg-blue-600 text-white hover:bg-blue-700 px-8 py-4 text-lg font-semibold rounded-xl shadow-lg hover:shadow-xl ripple-effect premium-press animate-premium-pulse inline-flex items-center gap-3"
              size="lg"
            >
      ...
      <div class="w-full max-w-3xl mx-auto">
          ...
          <template v-if="!showResult">
            <div class="space-y-4">
              <RadioGroup v-model="selectedAnswer" class="space-y-4">
                <div
                  ...
                  :key="index"
                  class="group relative bg-slate-50 hover:bg-blue-50 border-2 border-slate-200 hover:border-blue-300 rounded-xl p-4 cursor-pointer transition-all duration-200"
                  @click="selectedAnswer = index.toString()"
                >
                  <div class="flex items-center space-x-4">
                    <RadioGroupItem :value="index.toString()" :id="`option-${index}`" class="text-blue-600" />
            ...
            <div class="text-center pt-4">
              <Button
                ...
                class="bg-blue-600 text-white hover:bg-blue-700 disabled:bg-slate-300 disabled:cursor-not-allowed px-8 py-4 text-lg font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-200 inline-flex items-center gap-3"
                size="lg"
              >
                Confirm Answer
              </Button>
          ...
          <template v-else>
            <div class="space-y-6">
              ...
              >
                <div class="flex items-center justify-center mb-4">
                  <template v-if="Number.parseInt(selectedAnswer) === questions[currentQuestion].correct">
                    ...
                    <div class="text-center">
                      ...
                      <span class="text-green-700 font-medium">+$25 discount earned</span>
                    </div>
                  </template>
                  <template v-else>
                ...
                <div class="bg-white rounded-xl p-4 mb-4">
                  <p class="text-slate-700 font-medium mb-2">
                    <span class="text-blue-600 font-semibold">Correct answer:</span>
              ...
              <div class="text-center">
                <Button 
                  @click="nextQuestion" 
                  class="bg-blue-600 text-white hover:bg-blue-700 px-8 py-4 text-lg font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-200 inline-flex items-center gap-3"
                  size="lg"
                >
        ...
        <div class="mt-8 bg-white rounded-2xl p-6 shadow-sm border border-slate-200">
          <div class="flex justify-between items-center mb-4">
            <span class="text-slate-600 font-medium">Fan Discount Progress</span>
            <span class="font-poppins-bold text-lg text-slate-900">${{ correctAnswers * 25 }} / $100</span>
          </div>
    ...
    <div v-else-if="currentScreen === 'completed'" class="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 px-4 py-8 animate-zoom-in">
      <div class="w-full max-w-4xl mx-auto">
        <!-- Success Header -->
        <div class="text-center mb-12">
          ...
          <h1 class="text-3xl sm:text-4xl lg:text-5xl font-poppins-bold text-slate-900 mb-4 leading-tight">
            Congratulations,
            <span class="text-blue-600">True Thunder Fan!</span>
          </h1>
        ...
        <div class="space-y-8">
          ...
          <div class="bg-white rounded-2xl p-8 shadow-sm border border-slate-200 text-center">
            <div class="mb-6">
              <div class="inline-flex items-center gap-2 bg-blue-100 text-blue-800 px-6 py-3 rounded-full font-semibold mb-4">
                <Star class="h-5 w-5" />
                Verified Thunder Fan
              </div>
              <h2 class="text-2xl font-poppins-bold text-slate-900 mb-2">Your Fan Discount</h2>
              <div class="flex items-center justify-center gap-4 mb-4">
                <span class="text-4xl font-poppins-bold text-green-600">${{ correctAnswers * 25 }}</span>
                <span class="text-slate-500">discount earned</span>
              </div>
              <div class="flex items-center justify-center gap-2 text-slate-600">
                <span>Final price:</span>
                <span class="text-3xl font-poppins-bold text-blue-600">$49.99</span>
                <span class="text-lg text-slate-500 line-through">${{ 149.99 }}</span>
              </div>
            </div>
          </div>
          ...
          <div class="text-center space-y-4">
            <Button
              class="bg-gradient-to-r from-blue-600 to-blue-700 text-white hover:from-blue-700 hover:to-blue-800 px-6 sm:px-8 md:px-12 py-4 text-lg sm:text-xl font-bold rounded-xl shadow-lg hover:shadow-xl transition-all duration-200 inline-flex items-center gap-3"
              size="lg"
              @click="handleBuyNowClick"
            >
              <DollarSign class="h-6 w-6" />
              Claim Your Jersey Now
            </Button>
    ...
    <!-- Loading screen -->
    <div v-else-if="currentScreen === 'loading'" class="min-h-screen bg-gradient-to-br from-blue-900 to-indigo-900 px-4 py-8 flex items-center justify-center animate-fade-in">
      <div class="w-full max-w-md mx-auto text-center">
        ...
        <div class="relative mb-8">
          <div class="w-32 h-32 mx-auto relative">
            ...
            <div class="absolute inset-0 border-4 border-transparent border-t-blue-400 rounded-full animate-spin" style="animation-duration: 1s;"></div>
            
            <!-- Inner pulsing circle -->
            <div class="absolute inset-4 bg-gradient-to-br from-blue-400 to-blue-600 rounded-full flex items-center justify-center animate-pulse">
        ...
        <!-- Progress Bar -->
        <div class="w-full bg-blue-800 rounded-full h-3 mb-6 overflow-hidden">
          <div 
            class="h-full bg-gradient-to-r from-blue-400 to-blue-300 rounded-full transition-all duration-800 ease-out relative"
        ...
        <div class="mt-8 inline-flex items-center gap-2 bg-green-500 text-white px-6 py-3 rounded-full font-semibold animate-bounce">
          ...
          ${{ correctAnswers * 25 }} Discount Applied!
        </div>
      </div>
    </div>
  </div>
...
const currentScreen = ref<'products' | 'initial' | 'quiz' | 'completed' | 'loading'>('products')
...
const loadingText = ref("Loading Promotions...")
...
const handleBuyNowClick = () => {
  ...
  const loadingSteps = [
    { text: "Loading Promotions...", progress: 20 },
    { text: "Verifying Fan Status...", progress: 40 },
