<template>
  <div class="hero-product-section bg-gradient-to-br from-orange-50 to-slate-100px-4 rounded-2xl mb-8">
      ...
      <div class="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
        ...
        <div class="relative">
          ...
          <div class="relative bg-white rounded-2xl shadow-xl">
            <div class="w-730 h-96 rounded-xl bg-gradient-to-br from-slate-50 to-slate-100 flex items-center justify-center overflow-hidden">
              <img 
            ...
            <!-- Category Badge -->
            <div class="absolute bottom-4 left-4 bg-orange-100 text-orange-700 px-3 py-1 rounded-full text-sm font-medium">
        ...
        <div class="space-y-6">
          <div>
            <h3 class="text-center text-2xl mx-2 font-poppins-bold text-slate-900 mb-2">
              {{ featuredProduct.name }}
            </h3>
            <p class="text-slate-600 text-center text-lg mx-2">
